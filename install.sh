...
echo ""
echo "Usage:"
echo "  pomo-pet start              # Launch default pet (avocado)"
echo "  pomo-pet start avocado      # Launch specific pet"
echo "  pomo-pet list               # See available pets"
echo "  pomo-pet stats              # View statistics"
echo "  pomo-pet presets            # List technique presets"
echo "  pomo-pet config             # View settings"
echo ""
echo "Keyboard shortcuts (while pet is visible):"
echo "  Cmd+Shift+P  Pause/Resume"
echo "  Cmd+Shift+R  Reset timer"
echo "  Cmd+Shift+Q  Quit"
echo "  Arrow keys   Nudge pet position"
echo "  Right-click  Context menu with more options"
echo ""
